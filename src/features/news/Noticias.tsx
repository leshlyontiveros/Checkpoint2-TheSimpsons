...
import { INoticiasDisponiveis } from "./types";
import * as S from "./styled"



const Noticias = () => {
  const [noticias, setNoticias] = useState<INoticiasDisponiveis[]>([]);
  const [modal, setModal] = useState<INoticiasDisponiveis | null>(null);
